...
const NotificationIcon = () => (
  <button className={noficationIconStyle}>
...
const HeaderMenuMobile = () => (
  <div className="sm:hidden" id="mobile-menu">
    <div className="px-2 pt-2 pb-3 space-y-1">
      ...
      {headerLinksData.map(({link, label})=> (
        <a 
          href={link} 
          key={label}
...
const noficationIconStyle: string = `
  bg-gray-800 
  p-1 rounded-full 
  text-gray-400 
  hover:text-white 
...
const mobileMenuBtnStyle: string = `
  inline-flex 
  items-center 
  justify-center p-2 
  rounded-md 
